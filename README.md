...
외국어 미팅을 위한 **실시간 캡처 분석 + 미팅 후 종합 분석** Claude Code 플러그인.

두 가지 분석 축으로 미팅을 완벽하게 따라잡고 정리합니다:

1. **🔴 실시간 분석** — 매 캡처마다 즉시 짧은 분석. 미팅 중 흐름을 놓치지 않게.
2. **📘 종합 분석** — 미팅 종료 후 전체 흐름·결정·용어·다이어그램을 한 문서로 정리. 복습과 공유에.

둘 다 핵심입니다. 미팅 중에는 빠른 컨텍스트가 필요하고, 미팅 후에는 통합된 이해가 필요해요.
...
⭐ = 플러그인의 두 핵심 기능. 미팅 중과 미팅 후를 각각 책임진다.
...
| **📘 종합 분석** (`/meeting-review`) | 미팅 종료 후 명시 호출 | analysis.md 파일, 다이어그램 포함 | 복습, 공유, 다음 미팅 준비 |

서로 보완 관계입니다. 실시간 분석은 **순간을 살리고**, 종합 분석은 **전체를 정리**합니다.
